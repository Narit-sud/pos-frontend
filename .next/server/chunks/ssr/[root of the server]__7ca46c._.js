...
const userServices = {
    register: async (newUser)=>{
        ...
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$API_URL$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["USER_URL"], config);
            if (res.ok) {
                alert("ok");
...
function Page() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const submitComplete = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userServices"].register(newUser);
        console.log("submit");
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7ca46c._.js.map