(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_d82f76._.js", {
...
const userServices = {
    register: async (newUser)=>{
        ...
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$API_URL$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["USER_URL"], config);
            if (res.ok) {
                alert("ok");
...
function Page() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const submitComplete = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userServices"].register(newUser);
        console.log("submit");
    };
...
//# sourceMappingURL=_d82f76._.js.map